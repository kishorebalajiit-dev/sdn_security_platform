  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        {searchOpen ? (
          <div style={{ display: "flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(37,99,235,0.35)", borderRadius: "10px", padding: "7px 12px", width: "280px" }}>
      ...
      <div style={{ position: "relative" }}>
        <button
          ...
          style={{
            ...
            height: "36px",
            borderRadius: "10px",
            background: notifOpen ? "rgba(37,99,235,0.15)" : "rgba(255,255,255,0.04)",
            border: "1px solid rgba(37,99,235,0.15)",
            display: "flex",
            alignItems: "center",
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(37,99,235,0.35)"; (e.currentTarget as HTMLButtonElement).style.color = "#E2E8F0"; }}
          onMouseLeave={(e) => { if (!notifOpen) { (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(37,99,235,0.15)"; (e.currentTarget as HTMLButtonElement).style.color = "#94A3B8"; }}}
        >
          <Bell size={15} />
          {unreadCount > 0 && (
            <span
        ...
        {notifOpen && (
          ...
          >
            <div style={{ padding: "14px 16px", borderBottom: "1px solid rgba(37,99,235,0.12)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: "10px", color: "#2563EB", cursor: "pointer" }}>Mark all read</span>
            </div>
            {notifications.map((n) => (
              <div
                key={n.id}
              ...
              >
                {n.unread && (
                  <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: n.color, marginTop: "5px", flexShrink: 0, boxShadow: `0 0 6px ${n.color}` }} />
                )}
            ...
            <div style={{ padding: "10px 16px", textAlign: "center" }}>
              <span style={{ fontSize: "11px", color: "#2563EB", cursor: "pointer" }}>View all alerts →</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div style={{ position: "relative" }}>
        <button
          ...
          style={{
            ...
            alignItems: "center",
            gap: "10px",
            background: profileOpen ? "rgba(37,99,235,0.12)" : "rgba(255,255,255,0.04)",
            border: "1px solid rgba(37,99,235,0.15)",
            borderRadius: "10px",
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(37,99,235,0.35)"; }}
          onMouseLeave={(e) => { if (!profileOpen) (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(37,99,235,0.15)"; }}
        >
          <div
            style={{
              width: "28px",
          ...
          <div style={{ textAlign: "left" }}>
            <p style={{ fontSize: "12px", fontWeight: 600, color: "#E2E8F0", lineHeight: 1.2 }}>Kamran Singh</p>
            <p style={{ fontSize: "10px", color: "#475569" }}>SOC Manager</p>
          </div>
        ...
        {profileOpen && (
          ...
          >
            <div style={{ padding: "14px 16px", borderBottom: "1px solid rgba(37,99,235,0.12)" }}>
              <p style={{ fontSize: "13px", fontWeight: 600, color: "#E2E8F0" }}>Kamran Singh</p>
              <p style={{ fontSize: "11px", color: "#475569" }}>k.singh@secnet.ai</p>
            </div>
            {[
              ...
              <button key={item.label} style={{ width: "100%", display: "flex", alignItems: "center", gap: "10px", padding: "10px 16px", background: "none", border: "none", color: "#94A3B8", cursor: "pointer", fontSize: "12px", textAlign: "left" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "rgba(37,99,235,0.08)"; (e.currentTarget as HTMLButtonElement).style.color = "#E2E8F0"; }}
            ...
            <div style={{ borderTop: "1px solid rgba(37,99,235,0.12)" }}>
              <button style={{ width: "100%", display: "flex", alignItems: "center", gap: "10px", padding: "10px 16px", background: "none", border: "none", color: "#EF4444", cursor: "pointer", fontSize: "12px", textAlign: "left" }}
